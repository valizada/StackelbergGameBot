        ...
        extends PlayerImpl
{
    ...
    {
        super(PlayerType.LEADER, "Cube Leader");
    }
...
//            System.out.println("a: " + theta.get(0) + " b: " + theta.get(1));
            ...
            cubeRecursive.addData(m_platformStub.query(PlayerType.LEADER, p_date-1));
            theta = cubeRecursive.update(p_date-1);
            m_platformStub.publishPrice(m_type, maximiseRecursive(theta));
        }
...
//      m_platformStub.log(m_type, "current date: " + p_date);
            ...
            throws RemoteException
    {
        ...
        cubeRecursive = new CubeRecursive(historicalData);
        theta = cubeRecursive.baseCondition();
    }
    ...
    public float maximiseRecursive(FloatMatrix theta) throws RemoteException {
        ...
        for (float i = 1.001f; i <= 3.500f; i=i+0.001f) {
            ...
            float profit = (float) ((i-1)*(2-i+0.3*(theta.get(0) + theta.get(1)*i + theta.get(2) * i * i + theta.get(3)* i * i * i)));
