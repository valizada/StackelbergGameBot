 ...
 * @author Xin
 */
final class SquareLeader
        extends PlayerImpl
{
    ArrayList<Record> historicalData;
    private SquareLeader()
            throws RemoteException, NotBoundException
    {
        super(PlayerType.LEADER, "Square Leader");
    }
...
//            System.out.println("a: " + theta.get(0) + " b: " + theta.get(1));
            ...
            squareRecursive.addData(m_platformStub.query(PlayerType.LEADER, p_date-1));
            theta = squareRecursive.update(p_date-1);
            m_platformStub.publishPrice(m_type, maximiseRecursive(theta));
        }
...
//      m_platformStub.log(m_type, "current date: " + p_date);
    ...
    SquareRecursive squareRecursive;
    FloatMatrix theta;
    int p_steps = 0;
    /**
            ...
            throws RemoteException
    {
        ...
        squareRecursive = new SquareRecursive(historicalData);
        theta = squareRecursive.baseCondition();
    }
